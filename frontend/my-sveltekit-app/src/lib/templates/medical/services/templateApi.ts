/**
 * Medical Template API Service
 * 
 * Handles template-specific API operations for Medical template management
...
const logger = createTemplateLogger('medical', 'ApiService');

export class MedicalTemplateApiService implements TemplateApiService {
  private readonly baseUrl = '/api/templates/medical';
  private readonly templateId = 'medical';

  constructor() {
    logger.info('Initializing Medical Template API Service');
  }
  ...
  async getConfiguration(): Promise<MedicalTemplate> {
...
export const medicalTemplateApi = new MedicalTemplateApiService();
